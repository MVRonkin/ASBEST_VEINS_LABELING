...
class Annotation:
    def __init__(self, anno_path, image_dir_path = None):
        ...
        self.coco_anno_dict = coco_anno_dict
        self.coco           = coco
        self.image_dir_path = image_dir_path
    #------------------------------------
    def get_ anno_info(self):
        ''' Gwt Info Dict see anno_info'''
        return self.coco_anno_dict
    ...
    def get_anno_image(self, image_id = [1], cat_ids = None):
        ...
        '''
        return _get_coco_annotations(self.coco_anno_dict,  self.coco, image_id, cat_ids)
